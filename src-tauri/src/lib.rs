...
fn oauth_client_id(current: String, env_name: &str, embedded: Option<&str>) -> String {
...
fn runtime_settings(app_data: &Path) -> Result<RuntimeSettings, String> {
    ...
    if settings_path.exists() {
        ...
        settings.microsoft_oauth_client_id = oauth_client_id(
            settings.microsoft_oauth_client_id,
            "MICROSOFT_OAUTH_CLIENT_ID",
            option_env!("MICROSOFT_OAUTH_CLIENT_ID"),
        );
        return Ok(settings);
    }
    ...
    let settings = RuntimeSettings {
        ...
        microsoft_oauth_client_id: oauth_client_id(
            String::new(),
            "MICROSOFT_OAUTH_CLIENT_ID",
            option_env!("MICROSOFT_OAUTH_CLIENT_ID"),
        ),
