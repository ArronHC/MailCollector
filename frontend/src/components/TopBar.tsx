import { CheckCircle2, CircleHelp, LoaderCircle, LogOut, Menu, Search, Sparkles, TriangleAlert, UserRound } from "lucide-react";
...
export function UserActions({ backendLabel, onHelp, onManageAccounts, onLogout }: { backendLabel: string; onHelp: () => void; onManageAccounts: () => void; onLogout: () => void }) {
